// mgmtclassgen Win32_DiskDrive /P Path
...
{
	/// <summary>
	/// <para>Eine für die WMI-Klasse generierte Klasse mit früher Bindung.Win32_DiskDrive</para>
	/// </summary>
	/// <remarks>
	...
	/// <para>Die Funktionen 'ToDateTime' und 'ToDmtfDateTime' zum Konvertieren von Datum und Uhrzeit werden zu der Klasse hinzugefügt, damit DMTF-Zeitangaben in 'DateTime' konvertiert werden können (und umgekehrt).</para>
	/// </remarks>
    public class DiskDrive : Component {

		/// <summary>Private Eigenschaft, die den WMI-Namespace enthält, in dem sich die Klasse befindet.</summary>
        private static string CreatedWmiNamespace = "root\\CimV2";

		/// <summary>Private Eigenschaft, die den Namen der WMI-Klasse enthält, die diese Klasse erstellt hat.</summary>
        private static string CreatedClassName = "Win32_DiskDrive";

		/// <summary>Private Membervariable, die 'ManagementScope' enthält, das von den verschiedenen Methoden verwendet wird.</summary>
        private static ManagementScope statMgmtScope = null;
        
        private ManagementSystemProperties PrivateSystemProperties;

		/// <summary>Zugrunde liegendes lateBound-WMI-Objekt.</summary>
        private ManagementObject PrivateLateBoundObject;

		/// <summary>Membervariable, in der das automatic commit-Verhalten für die Klasse gespeichert wird.</summary>
        private bool AutoCommitProp;

		/// <summary>Private Variable, die die eingebettete Eigenschaft enthält, die die Instanz darstellt.</summary>
        private ManagementBaseObject embeddedObj;

		/// <summary>Das aktuelle WMI-Objekt.</summary>
        private ManagementBaseObject curObj;

		/// <summary>Flag zum Anzeigen, ob die Instanz ein eingebettetes Objekt ist.</summary>
		...
		/// <summary></summary>
		/// <param name="keyDeviceID"></param>
        public DiskDrive(string keyDeviceID) {
            this.InitializeObject(null, new ManagementPath(DiskDrive.ConstructPath(keyDeviceID)), null);
        }

		/// <summary></summary>
		/// <param name="mgmtScope"></param>
		/// <param name="keyDeviceID"></param>
        public DiskDrive(ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((ManagementScope)(mgmtScope)), new ManagementPath(DiskDrive.ConstructPath(keyDeviceID)), null);
        }

		/// <summary></summary>
		/// <param name="path"></param>
		/// <param name="getOptions"></param>
        public DiskDrive(ManagementPath path, ObjectGetOptions getOptions) {
		...
		/// <param name="path"></param>
		/// <param name="mgmtScope"></param>
        public DiskDrive(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }

		/// <summary></summary>
		/// <param name="path"></param>
        public DiskDrive(ManagementPath path) {
		...
		/// <param name="path"></param>
		/// <param name="getOptions"></param>
        public DiskDrive(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
		/// <summary></summary>
		/// <param name="theObject"></param>
        public DiskDrive(ManagementObject theObject) {
            Initialize();
		...
		/// <summary></summary>
		/// <param name="theObject"></param>
        public DiskDrive(ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
		...
		/// <summary>Die Eigenschaft gibt den Namespace der WMI-Klasse zurück.</summary>
        [Browsable(true)]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"BytesPerSector\" gibt die Anzahl der Bytes in jedem Sektor des ph" +
            "ysikalischen Laufwerks an.\nBeispiel: 512")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
...
Für einige der aufgezählten Werte sind Erläuterungen erforderlich: 1) Wert 11: Unterstützt zweiseitige Medien und unterscheidet zwischen einem Gerät, das auf beide Seiten des zweiseitigen Mediums zugreifen kann, und einem Gerät, das nur auf eine Seite zugreifen kann, so dass das Medium umgedreht werden muss. 2) Wert 12: Bereitstellungsaufhebung zum Auswerfen ist nicht erforderlich. Dies bedeutet, dass Medien nicht explizit aus dem Gerät ausgeworfen werden müssen, bevor ein ""PickerElement"" darauf zugreifen kann.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DeviceID\" enthält eine Zeichenfolge, die das Laufwerk von andere" +
            "n Geräten im System unterscheidet.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die \"Firmware Revision\"-Eigenschaft ist eine vom Hersteller zugewiesene Nummer zu" +
            "r Identifizierung des physikalischen Mediums.")]
        public string FirmwareRevision {
            get {
                return ((string)(curObj["FirmwareRevision"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Index\" gibt die physikalische Laufwerksnummer des angegebenen La" +
            "ufwerks an. Der Wert 0xFF gibt an, dass das angegebene Laufwerk keinem physikali" +
            "schen Laufwerk zugeordnet ist.\nBeispiel: 1")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint Index {
            get {
                if ((curObj["Index"] == null)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"InterfaceType\" gibt den Schnittstellentyp des physikalischen Lau" +
            "fwerks an.\nBeispiel: SCSI")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Manufacturer\" gibt den Hersteller des Laufwerks an.\nBeispiel: Se" +
            "agate")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"MediaLoaded\" gibt an, ob das Medium geladen ist. Für Festplatten" +
            " ist diese Eigenschaft immer TRUE.\nWerte: TRUE oder FALSE. TRUE gibt an, dass da" +
            "s Medium geladen ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Model\" gibt die Modellnummer des Laufwerks an.\nBeispiel: ST32171" +
            "W")]
        public string Model {
            get {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Partitions\" gibt die Anzahl der Partitionen auf dem physikalisch" +
            "en Laufwerk an, die vom Betriebssystem erkannt werden.\nBeispiel: 2")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"SCSILogicalUnit\" gibt die SCSI LUN (Logical Unit Number) des Lau" +
            "fwerks an.\nBeispiel: 0")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"SCSITargetId\" gibt die SCSI-Kennung des Laufwerks an.\nBeispiel: " +
            "0.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"SectorsPerTrack\" gibt die Anzahl der Sektoren in jeder Spur des " +
            "physikalischen Laufwerks an.\nBeispiel: 63")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Signature\" wird zum Identifizieren eines Datenträgers verwendet." +
            " Die Eigenschaft kann auch zum Identifizieren einer freigegebenen Ressource verw" +
            "endet werden. ")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Size\" gibt die Größe des Laufwerks an. Diese wird durch Multipli" +
            "zieren aller Zylinder, der Spuren in den Zylindern, der Sektoren in den Spuren u" +
            "nd den Bytes in den Sektoren berechnet.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public ulong Size {
            get {
                if ((curObj["Size"] == null)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""TotalCylinders"" gibt die Gesamtanzahl der Zylinder auf dem physikalischen Laufwerk an. Hinweis: Der Wert für diese Eigenschaft wird über die erweiterte Funktion von BIOS Interrupt 13h ermittelt. Der Wert ist möglicherweise ungenau, wenn das Laufwerk ein Übersetzungsschema verwendet, um Datenträger mit hoher Kapazität zu unterstützen. Fordern Sie beim Hersteller genaue Laufwerkspezifikationen an.
Beispiel: 657")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""TotalHeads"" gibt die Gesamtanzahl der Köpfe auf dem Laufwerk an. Hinweis: Der Wert für diese Eigenschaft wird über die erweiterte Funktion von BIOS Interrupt 13h ermittelt. Der Wert ist möglicherweise ungenau, wenn das Laufwerk ein Übersetzungsschema verwendet, um Datenträger mit hoher Kapazität zu unterstützen. Fordern Sie beim Hersteller genaue Laufwerkspezifikationen an.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""TotalSectors"" gibt die Gesamtanzahl der Sektoren auf dem physikalischen Laufwerk an. Hinweis: Der Wert für diese Eigenschaft wird über die erweiterte Funktion von BIOS Interrupt 13h ermittelt. Der Wert ist möglicherweise ungenau, wenn das Laufwerk ein Übersetzungsschema verwendet, um Datenträger mit hoher Kapazität zu unterstützen. Fordern Sie beim Hersteller genaue Laufwerkspezifikationen an.
Beispiel: 2649024")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""TotalTracks"" gibt die Gesamtanzahl der Spuren auf dem physikalischen Laufwerk an. Hinweis: Der Wert für diese Eigenschaft wird über die erweiterte Funktion von BIOS Interrupt 13h ermittelt. Der Wert ist möglicherweise ungenau, wenn das Laufwerk ein Übersetzungsschema verwendet, um Datenträger mit hoher Kapazität zu unterstützen. Fordern Sie beim Hersteller genaue Laufwerkspezifikationen an.
Beispiel: 42048")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""TracksPerCylinder"" gibt die Anzahl der Spuren in jedem Zylinder auf dem physikalischen Laufwerk an. Hinweis: Der Wert für diese Eigenschaft wird über die erweiterte Funktion von BIOS Interrupt 13h ermittelt. Der Wert ist möglicherweise ungenau, wenn das Laufwerk ein Übersetzungsschema verwendet, um Datenträger mit hoher Kapazität zu unterstützen. Fordern Sie beim Hersteller genaue Laufwerkspezifikationen an.
Beispiel: 64")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        public static DiskDriveCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
        ...
        public static DiskDriveCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static DiskDriveCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static DiskDriveCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CimV2";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_DiskDrive", condition, selectedProperties));
        ...
        public class DiskDriveCollection : object, ICollection {
            ...
            public virtual void CopyTo(Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new DiskDrive(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class DiskDriveEnumerator : object, IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new DiskDrive(((ManagementObject)(privObjEnum.Current)));
                    }
                }
