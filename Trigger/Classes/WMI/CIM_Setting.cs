namespace ROOT.CIMV2.CIM {
    ...
    // Eine für die WMI-Klasse generierte Klasse mit früher Bindung.CIM_Setting
    public class Setting : System.ComponentModel.Component {
        ...
        private static string CreatedClassName = "CIM_Setting";
        ...
        public Setting(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public Setting(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public Setting(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public Setting(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Setting(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public Setting(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        private void ResetSettingID() {
            curObj["SettingID"] = null;
            if (((isEmbedded == false) 
                        && (AutoCommitProp == true))) {
                PrivateLateBoundObject.Put();
            }
        ...
        private static string ConstructPath() {
            string strPath = "root\\CimV2:CIM_Setting";
            return strPath;
        }
        ...
        public static SettingCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static SettingCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static SettingCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static SettingCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static SettingCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            return new SettingCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static SettingCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static SettingCollection GetInstances(System.Management.ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static SettingCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CimV2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("CIM_Setting", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new SettingCollection(ObjectSearcher.Get());
        }
        ...
        public static Setting CreateInstance() {
            ...
            return new Setting(tmpMgmtClass.CreateInstance());
        }
        ...
        public class SettingCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public SettingCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Setting(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new SettingEnumerator(privColObj.GetEnumerator());
            }
            
            public class SettingEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public SettingEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new Setting(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
