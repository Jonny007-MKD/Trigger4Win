...
namespace Trigger.Classes.WMI
{
    ...
    // Eine für die WMI-Klasse generierte Klasse mit früher Bindung.Win32_LogicalDisk
    public class LogicalDisk : Component {
        ...
        public LogicalDisk(string keyDeviceID) {
            this.InitializeObject(null, new ManagementPath(LogicalDisk.ConstructPath(keyDeviceID)), null);
        }
        
        public LogicalDisk(ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((ManagementScope)(mgmtScope)), new ManagementPath(LogicalDisk.ConstructPath(keyDeviceID)), null);
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Compressed\" gibt an, ob der logische Datenträger als einzelne ko" +
            "mprimierte Einheit vorhanden ist; z. B. als ein DoubleSpace-Datenträger. Wenn di" +
            "e Datei-basierte Komprimierung (z. B. NTFS) unterstützt wird, ist diese Eigensch" +
            "aft FALSE.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DeviceID\" enthält eine Zeichenfolge, die den logischen Datenträg" +
            "er von anderen Geräten im System unterscheidet.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DriveType\" enthält einen numerischen Wert entsprechend dem Laufw" +
            "erk, das dieser logische Datenträger darstellt. Zusätzliche Werte finden Sie in " +
            "der SDK-Dokumentation.\nBeispiel: Ein CD-ROM-Laufwerk würde 5 zurückgeben.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"FileSystem\" gibt das Dateisystem auf dem logischen Datenträger a" +
            "n.\nBeispiel: NTFS")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"FreeSpace\" zeigt an, wie viel freier Speicherplatz in Bytes auf " +
            "dem logischen Datenträger verfügbar ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""MaximumComponentLength"" gibt die maximale Länge einer Dateinamenkomponente an, die vom Win32-Laufwerk unterstützt wird. Eine Dateinamenkomponente ist der Teil des Dateinamens zwischen den umgekehrten Schrägstrichen. Der Wert kann verwendet werden, um anzugeben, ob lange Dateinamen von einem Dateisystem unterstützt werden. Für ein FAT-Dateisystem, das lange Namen unterstützt, wird z. B. der Wert 255 gespeichert, statt 8.3. Lange Namen können auch von NTFS-Dateisystemen unterstützt werden.
Beispiel: 255")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""MediaType"" gibt den Medientyp an, der sich im logischen Laufwerk befindet. Dieser Wert wird in der Aufzählung MEDIA_TYPE in winioctl.h angegeben.
<B>Hinweis:</B> Der Wert ist für austauschbare Laufwerke möglicherweise nicht genau, wenn sich kein Medium im Laufwerk befindet.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public MediaTypeValues MediaType {
            get {
                if ((curObj["MediaType"] == null)) {
                    return ((MediaTypeValues)(Convert.ToInt32(23)));
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"ProviderName\" gibt den Netzwerkpfad zum logischen Gerät an.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"QuotasDisabled\" zeigt an, dass die Kontingentverwaltung auf dies" +
            "em Volume nicht aktiviert ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"QuotasIncomplete\" zeigt an, dass die Kontingentverwaltung verwen" +
            "det aber deaktiviert wurde. Unvollständig verweist auf die Informationen, die im" +
            " Dateisystem zurückgeblieben sind, nachdem die Kontingentverwaltung deaktiviert " +
            "wurde.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"QuotasRebuilding\" zeigt einen aktiven Zustand an, d.h. das Datei" +
            "system ist im Begriff, Informationen zu kompilieren und den Datenträger für die " +
            "Kontingentverwaltung einzurichten.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Size\" gibt die Größe des logischen Laufwerks in Bytes an.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public ulong Size {
            get {
                if ((curObj["Size"] == null)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"SupportsDiskQuotas\" gibt an, ob dieses Volume Datenträgerkonting" +
            "ente unterstützt.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""SupportsFileBasedCompression"" gibt an, ob die Datei-basierte Komprimierung, z. B. NTFS, von der logischen Datenträgerpartition unterstützt wird. Diese Eigenschaft ist FALSE, wenn die Eigenschaft ""Compressed"" TRUE ist.
Werte: TRUE oder FALSE. TRUE gibt an, dass der logische Datenträger die Komprimierung unterstützt.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""VolumeDirty"" gibt an, ob chkdsk auf dem Datenträger beim nächsten Neustart ausgeführt werden muss. Die Eigenschaft gilt nur für die Instanzen des logischen Datenträgers, die einen physikalischen Datenträger auf dem Computer darstellen. Die Eigenschaft kann nicht auf zugeordnete logische Laufwerke angewendet werden. ")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"VolumeName\" gibt den Datenträgernamen des logischen Datenträgers" +
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"VolumeSerialNumber\" gibt die Volumeseriennummer des logischen Da" +
        ...
        public static LogicalDiskCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CimV2";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_LogicalDisk", condition, selectedProperties));
        ...
        public enum MediaTypeValues {
            ...
            Unbekanntes_Format = 0,
            
            Val_5_25_Zoll_Diskette = 1,
            
            Val_3_5_Zoll_Diskette = 2,
            
            Val_3_5_Zoll_Diskette0 = 3,
            
            Val_3_5_Zoll_Diskette1 = 4,
            
            Val_3_5_Zoll_Diskette2 = 5,
            
            Val_5_25_Zoll_Diskette0 = 6,
            
            Val_5_25_Zoll_Diskette1 = 7,
            
            Val_5_25_Zoll_Diskette2 = 8,
            
            Val_5_25_Zoll_Diskette3 = 9,
            
            Val_5_25_Zoll_Diskette4 = 10,
            
            Wechseldatenträger_keine_Diskette_ = 11,
            
            Festplattenmedium = 12,
            
            Val_3_5_Zoll_Diskette3 = 13,
            
            Val_3_5_Zoll_Diskette4 = 14,
            
            Val_5_25_Zoll_Diskette5 = 15,
            
            Val_5_25_Zoll_Diskette6 = 16,
            
            Val_3_5_Zoll_Diskette5 = 17,
            
            Val_3_5_Zoll_Diskette6 = 18,
            
            Val_5_25_Zoll_Diskette7 = 19,
            
            Val_3_5_Zoll_Diskette7 = 20,
            
            Val_3_5_Zoll_Diskette8 = 21,
            
            Val_8_Zoll_Diskette = 22,
        ...
        public class LogicalDiskCollection : object, ICollection {
            ...
            public class LogicalDiskEnumerator : object, IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new LogicalDisk(((ManagementObject)(privObjEnum.Current)));
                    }
                }
