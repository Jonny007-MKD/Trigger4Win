...
namespace Trigger.Classes.WMI
{
    ...
    // Eine für die WMI-Klasse generierte Klasse mit früher Bindung.Win32_DiskPartition
    public class DiskPartition : Component {
        ...
        private static string CreatedClassName = "Win32_DiskPartition";
        ...
        public DiskPartition(string keyDeviceID) {
            this.InitializeObject(null, new ManagementPath(DiskPartition.ConstructPath(keyDeviceID)), null);
        }
        
        public DiskPartition(ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((ManagementScope)(mgmtScope)), new ManagementPath(DiskPartition.ConstructPath(keyDeviceID)), null);
        }
        
        public DiskPartition(ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public DiskPartition(ManagementScope mgmtScope, ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public DiskPartition(ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public DiskPartition(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public DiskPartition(ManagementObject theObject) {
            Initialize();
        ...
        public DiskPartition(ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("\"Access\" gibt an, ob das Medium lesbar (Wert=1), beschreibbar (Wert=2) oder beide" +
            "s (Wert=3) ist. \"Unbekannt\" (0) und \"Write Once\" (4) können ebenfalls definiert " +
            "werden.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public AccessValues Access {
            get {
                if ((curObj["Access"] == null)) {
                    return ((AccessValues)(Convert.ToInt32(5)));
                }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Größe der Speichererweiterungsblöcke in Bytes. Falls die Blockgröße eine Variable ist, muss die maximale Blockgröße eingegeben werden. Geben Sie 1 ein, wenn die Größe unbekannt oder ein Blockkonzept ungültig ist (z. B. für zusammengesetzte Erweiterungen, Speicher oder logische Datenträger).")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsBootableNull {
            get {
                if ((curObj["Bootable"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Boolescher Wert, der angibt, dass \"DiskPartition\" als startbar bezeichnet ist. Di" +
            "es bedeutet nicht unbedingt, dass auf der Partition \"OperatingSystem\" geladen is" +
            "t.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool Bootable {
            get {
                ...
                return ((bool)(curObj["Bootable"]));
            }
        }
        
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsBootPartitionNull {
            get {
                if ((curObj["BootPartition"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"BootPartition\" legt die aktive Partition fest. Die aktive Partit" +
            "ion wird vom Betriebssystem zum Starten von der Festplatte verwendet.\nWerte: TRU" +
            "E oder FALSE. TRUE gibt an, dass die Partition aktiv ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool BootPartition {
            get {
                ...
                return ((bool)(curObj["BootPartition"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DeviceID\" enthält eine Zeichenfolge, die das Laufwerk und die Pa" +
            "rtition eindeutig kennzeichnet.")]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsDiskIndexNull {
            get {
                if ((curObj["DiskIndex"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DiskIndex\" gibt die Indexnummer des Datenträgers mit der Partiti" +
            "on an.\nBeispiel: 0.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die formfreie Zeichenfolge \"ErrorMethodology\" beschreibt den Typ der Fehlererkenn" +
            "ung und -korrektur, der von dieser Speichererweiterung unterstützt wird.")]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsHiddenSectorsNull {
            get {
                if ((curObj["HiddenSectors"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"HiddenSectors\" gibt die Anzahl der versteckten Sektoren in der P" +
            "artition an.\nBeispiel: 63")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint HiddenSectors {
            get {
                ...
                return ((uint)(curObj["HiddenSectors"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Index\" gibt die Indexnummer der Partition an.\nBeispiel: 1")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint Index {
            get {
                if ((curObj["Index"] == null)) {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsPrimaryPartitionNull {
            get {
                if ((curObj["PrimaryPartition"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Boolescher Wert, der angibt, dass \"DiskPartition\" als primäre Partition für \"Comp" +
            "uterSystem\" bezeichnet ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool PrimaryPartition {
            get {
                ...
                return ((bool)(curObj["PrimaryPartition"]));
            }
        }
        
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Formfreie Zeichenfolge, die das Medium und/oder seine Verwendung beschreibt.")]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsRewritePartitionNull {
            get {
                if ((curObj["RewritePartition"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""RewritePartition"" gibt an, ob die Partitionsinformationen geändert wurden. Wenn eine Partition mit IOCTL_DISK_SET_DRIVE_LAYOUT geändert wird, wird mit diesem Mitglied bestimmt, welche Partition geändert wurde und neu geschrieben werden muss.
Werte: TRUE oder FALSE. TRUE gibt an, dass die Partition neu geschrieben werden muss.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public bool RewritePartition {
            get {
                ...
                return ((bool)(curObj["RewritePartition"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Size\" gibt die Gesamtgröße der Partition in Bytes an.\nBeispiel: " +
            "1059045376")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public ulong Size {
            get {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsStartingOffsetNull {
            get {
                if ((curObj["StartingOffset"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"StartingOffset\" gibt den Startoffset (in Bytes) der Partition.\nB" +
            "eispiel: 32256")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public ulong StartingOffset {
            get {
                ...
                return ((ulong)(curObj["StartingOffset"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Type\" gibt den Partitionstyp an.")]
        public string Type {
            get {
        ...
        private bool ShouldSerializeBootable() {
            if ((this.IsBootableNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeBootPartition() {
            if ((this.IsBootPartitionNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeDiskIndex() {
            if ((this.IsDiskIndexNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeHiddenSectors() {
            if ((this.IsHiddenSectorsNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializePrimaryPartition() {
            if ((this.IsPrimaryPartitionNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializeRewritePartition() {
            if ((this.IsRewritePartitionNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializeStartingOffset() {
            if ((this.IsStartingOffsetNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "root\\CimV2:Win32_DiskPartition";
        ...
        public static DiskPartitionCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static DiskPartitionCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static DiskPartitionCollection GetInstances(string[] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(string condition, string[] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
        ...
        public static DiskPartitionCollection GetInstances(ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static DiskPartitionCollection GetInstances(ManagementScope mgmtScope, string[] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static DiskPartitionCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CimV2";
            ...
            ManagementObjectSearcher ObjectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_DiskPartition", condition, selectedProperties));
        ...
        [Browsable(true)]
        public static DiskPartition CreateInstance() {
        ...
        public enum AccessValues {
            ...
            Lesen_schreiben_wird_unterstützt = 3,
            
            Einmal_beschreibbar = 4,
        ...
        public class DiskPartitionCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public DiskPartitionCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new DiskPartition(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class DiskPartitionEnumerator : object, IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public DiskPartitionEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new DiskPartition(((ManagementObject)(privObjEnum.Current)));
                    }
                }
